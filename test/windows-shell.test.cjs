...
assert.match(main, /createDesktopStore/);
assert.match(main, /app\.getPath\('userData'\)/);
assert.match(main, /tolou:workspace:load/);
assert.match(main, /tolou:workspace:save/);
assert.match(main, /tolou:workspace:backup/);
assert.match(main, /tolou:workspace:restore/);
