...
const projectContext={id:PROJECT_ID,code:'TL-DEMO-25-400',name:'مجتمع اداری آفتاب شرق — فاز ۱ (پروژه نمونه)',designScope:'base',structureType:'building',commonSettings:{ambientTemp:25,humidity:55,transportDist:15,transportTime:30},requirements:{fc:25,slump:100,maxWcm:.50,standard:'نشریه ض-479، چاپ دوم 1388 + INSO 302:1399 (سنگدانه)',exposure:'شرایط معمول داخلی / غیرمهاجم — سناریوی QA'},baseSettings:{methodId:'iran479',standardType:'isiri',slump:100,maxAggSize:25,environment:'normal',airSystem:'non-air',iranSiteGrade:'',iranFcClass:''},specialSettings:{concreteType:'scc',standardType:'aci',targetWc:null},capturedAt:'2026-05-24T11:00:00+03:30'};
